...
namespace WebAPI.Controllers
{
    ...
    public class LanguagesController : BaseController
    {
        ...
        [HttpPut]
        public async Task<IActionResult> Update(UpdateLanguageCommand updateLanguageCommand)
        {
        ...
        [HttpDelete]
        public async Task<ActionResult> Delete([FromBody] DeleteLanguageCommand deleteLanguageCommand)
        {
